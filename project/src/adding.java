...
public class adding extends checking {
    ...
    public static ArrayList<normalemployee> normalEmployees = new ArrayList<>();
...
/*---------------------------------------------------------------------------------------------------------------------------- */
    ...
    public static void addFlighter(){
        ...
        System.out.println("enter how many rokhas does the flighter have");
            ...
            numberhere = checking.getValidInt(); // Use the method to get a valid int
         if (numberhere != 0 ) {
            rokhaschecking = false ;
         }
         else if (numberhere == 0 ) {
            rokhaschecking = true ;
    ...
    public static void addFlight(){
        ...
        while (numofchairwithpasschecking) {
            if (numberofpassengeres > numberofchairs) {
                ...
                System.out.println("you have " + numberofchairs + " chairs, try again");
                System.out.println("enter the number of passengeres in this flight");
                numberofpassengeres = checking.getValidInt();
            }
            else {
    ...
    Flight s1 = new Flight(destination, listofthepassengeres, captin, choosencopilots, numofchairs);
    flightslists.add(s1);
